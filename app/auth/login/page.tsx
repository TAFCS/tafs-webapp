    ...
    return (
        <div className="w-full max-w-md space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <form
                ...
                className="mt-8 space-y-6 border-t border-zinc-100 dark:border-zinc-800 pt-8"
            >
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center">
                        <input
                            ...
                            name="remember-me"
                            type="checkbox"
                            className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-zinc-300 dark:border-zinc-700 rounded bg-white dark:bg-zinc-900"
                        />
                        <label
                            htmlFor="remember-me"
