        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-zinc-500 mt-1">Manage structural fee categories and amounts.</p>
                </div>
            </div>
            ...
            <div className="bg-white border border-zinc-200 rounded-xl shadow-sm overflow-hidden p-6">
                <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <h3 className="text-sm font-medium text-zinc-900">Fee Types management coming soon</h3>
