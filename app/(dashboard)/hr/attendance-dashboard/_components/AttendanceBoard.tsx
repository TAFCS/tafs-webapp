...
interface AttendanceBoardProps {
    /** Shows the page-level "Attendance Dashboard" heading + subtitle. Off when embedded elsewhere (e.g. the HR home dashboard), which already has its own module header. */
    showHeader?: boolean;
}

export function AttendanceBoard({ showHeader = true }: AttendanceBoardProps) {
