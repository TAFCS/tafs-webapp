...
import { X, Loader2, User, BookOpen, GraduationCap, Shield, FileText, RotateCcw, History, ShieldAlert, DoorOpen, Ban, ChevronDown } from "lucide-react";
...
export function StudentDetailPanel({ cc, onClose, onSwitchStudent, classes = [], onUpdated }: Props) {
