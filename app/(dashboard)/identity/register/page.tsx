    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-semibold tracking-tight text-zinc-900 dark:text-zinc-100">New Enrollment</h1>
                    <p className="text-zinc-500 dark:text-zinc-400 mt-1">Select the appropriate form to proceed with student enrollment.</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8 max-w-4xl mx-auto">
                <Link href="/identity/register/registration-form" className="group block">
                    <div className="bg-white dark:bg-zinc-950 border text-left border-zinc-200 dark:border-zinc-800 rounded-2xl p-8 shadow-sm hover:shadow-md hover:border-primary/40 transition-all h-full relative overflow-hidden">
                        ...
                        <h2 className="text-2xl font-semibold text-zinc-900 dark:text-zinc-100 group-hover:text-primary transition-colors mb-3">Registration Form</h2>
                ...
                <Link href="/identity/register/admission-form" className="group block">
                    <div className="bg-white dark:bg-zinc-950 border text-left border-zinc-200 dark:border-zinc-800 rounded-2xl p-8 shadow-sm hover:shadow-md hover:border-emerald-600/40 transition-all h-full relative overflow-hidden">
                        <div className="absolute top-0 right-0 p-6 opacity-0 group-hover:opacity-100 transition-opacity translate-x-4 group-hover:translate-x-0 duration-300">
