...
export const LEAVE_REQUESTS_TILE = "attendance.leave_requests";

/**
 * Sub-permissions of Leave Requests (/hr/leaves), for hiding and disabling UI.
 *
 * `view` covers loading and viewing leave applications and review history.
 * `approve` covers approving, rejecting, or revoking employee leave requests.
 *
 ...
 */
export function useLeaveRequestsAccess() {
  const tile = useTileAccess(LEAVE_REQUESTS_TILE);
