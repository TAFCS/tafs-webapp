...
export const DISCOUNT_PRESETS_TILE = "school-setup.discount_presets";

/**
 * Sub-permissions of Discount Presets, for hiding and disabling UI.
 *
 ...
 */
export function useDiscountPresetsAccess() {
    const tile = useTileAccess(DISCOUNT_PRESETS_TILE);
