...
export const FEE_TYPES_TILE = "school-setup.fee_types";

/**
 * Sub-permissions of Fee Types, for hiding and disabling UI.
 *
 ...
 */
export function useFeeTypesAccess() {
    const tile = useTileAccess(FEE_TYPES_TILE);
