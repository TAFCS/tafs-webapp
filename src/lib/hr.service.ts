...
export interface SalaryIncrementHistory { id: number; mode: SalaryIncrementMode; percentage: string | null; fixed_amount: string | null; previous_pay: string; new_pay: string; cycle_months_used?: number; effective_from: string; applied_at: string; applied_by: string | null; notes: string | null; bulk_batch_id?: string | null; }
