...
export const NAV_MODULES: NavModule[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { id: "school-setup.segments", name: "Segments", description: "Wings that group classes and staff", href: "/segments", icon: Layers, permission: "academic.classes.view" },
