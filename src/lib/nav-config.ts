...
export const NAV_MODULES: NavModule[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { name: "Deposit Report", description: "Cash view — banked deposits with LPS breakdown", href: "/financial-reports/deposits", icon: Wallet, permission: "system.analytics.view" },
